...
Source0  : https://github.com/darktable-org/darktable/releases/download/release-2.2.3/darktable-2.2.3.tar.xz
...
%prep
%setup -q -n darktable-2.2.3
%patch1 -p1

%build
export LANG=C
export SOURCE_DATE_EPOCH=1485959241
mkdir clr-build
pushd clr-build
export AR=gcc-ar
