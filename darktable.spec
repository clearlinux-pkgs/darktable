...
Source0  : https://github.com/darktable-org/darktable/releases/download/release-4.6.0/darktable-4.6.0.tar.xz
...
Source2  : https://github.com/darktable-org/darktable/releases/download/release-4.6.0/darktable-4.6.0.tar.xz.asc
...
%prep
%setup -q -n darktable-4.6.0
cd %{_builddir}
tar xf %{_sourcedir}/rawspeed-200bfa7408cedeac340eea86570fb633831acf7c.tar.gz
cd %{_builddir}/darktable-4.6.0
mkdir -p src/external/rawspeed
cp -r %{_builddir}/rawspeed-200bfa7408cedeac340eea86570fb633831acf7c/* %{_builddir}/darktable-4.6.0/src/external/rawspeed
%patch -P 1 -p1
...
export LANG=C.UTF-8
export SOURCE_DATE_EPOCH=1708121001
mkdir -p clr-build
pushd clr-build
