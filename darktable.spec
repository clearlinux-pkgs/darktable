...
Source0  : https://github.com/darktable-org/darktable/releases/download/release-2.2.4/darktable-2.2.4.tar.xz
...
%prep
%setup -q -n darktable-2.2.4
%patch1 -p1

%build
export LANG=C
export SOURCE_DATE_EPOCH=1491353090
mkdir clr-build
pushd clr-build
export AR=gcc-ar
